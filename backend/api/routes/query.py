"""
This module defines the FastAPI routes for querying the
Regulatory document database using
...
answers and sources
- query_documents: Main endpoint that processes compliance queries
...
from backend.agents.rag_agent import RegRagAgent
